...
const styles = StyleSheet.create({
  ...
  glassPill: { flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: 'rgba(255, 255, 255, 0.05)', paddingHorizontal: 12, paddingVertical: 10, borderRadius: BorderRadius.pill, borderWidth: 1, borderColor: 'rgba(255, 255, 255, 0.1)' },
  ...
  expChip: { paddingHorizontal: 10, paddingVertical: 6, borderRadius: BorderRadius.pill, backgroundColor: 'rgba(255, 255, 255, 0.05)', borderWidth: 1, borderColor: 'rgba(255, 255, 255, 0.08)' },
  ...
  segmentedRow: { flexDirection: 'row', backgroundColor: 'rgba(15, 17, 21, 0.7)', borderRadius: BorderRadius.pill, padding: 3, borderWidth: 1, borderColor: Colors.surfaceBorder },
  segmentBtn: { flex: 1, paddingVertical: 10, alignItems: 'center', borderRadius: BorderRadius.pill },
  ...
  continueButton: { borderRadius: BorderRadius.pill, overflow: 'hidden', shadowColor: Colors.primary, shadowOffset: { width: 0, height: 6 }, shadowOpacity: 0.35, shadowRadius: 10, elevation: 6 },
